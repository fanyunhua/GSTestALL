...
public class ENVPFragment1 extends Fragment {
    LineChart lineChart;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_en_vp_item_fragment1,null);
    ...
    private void requestData() {
        String sql = "select w,dt from env order by dt desc limit 0,21";
